...
- [AI Crypto Trader](https://github.com/divyn/AI-crypto-trader-all-in-one-CoW-Intent) — Autonomous trading bot using GPT-4o/Claude with CoW Intent execution on Base
- [AMM Flow Toxicity Engine](https://github.com/divyn/amm-flow-toxicity-alpha-engine) — Measures toxic vs. uninformed flow in Uniswap pools
